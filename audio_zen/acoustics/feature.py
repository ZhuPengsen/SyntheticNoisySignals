...
# 注意在输入前，已经sub_sample_length=int(self.sub_sample_length * self.sr)，因此此处不是3s而是样本长度
# 该函数根据输入信号长度和指定的sub_sample_length对信号读如，大于指定长度，且start_position<0，则len-sub_length随机指定起始位置
# 若样本长度小于指定长度则在后面补零
def subsample(
